...
import { GrandVitaraModel } from "@/components/digital-twin-viewer/GrandVitaraModel"
...
export function TwinCanvas({ telemetry }: TwinCanvasProps) {
  return (
    <div className="h-full min-h-[320px] w-full rounded-xl bg-gradient-to-b from-slate-950 to-slate-900">
      <Canvas shadows camera={{ position: [2.8, 1.5, 2.9], fov: 42 }} dpr={[1, 2]}>
        ...
        <GrandVitaraModel telemetry={telemetry} />
